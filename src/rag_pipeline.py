...
class RAGPipeline:
    ...
    def analyze_article(self, text: str, model_name: str = "llama3.2", n_results: int = 5) -> str:
        """
        ...
        print("[INFO] Étape 2 - Recherche des articles similaires dans la base vectorielle...")
        docs, metas = self.retriever.retrieve_similar_docs(query_vector, n_results=n_results)
